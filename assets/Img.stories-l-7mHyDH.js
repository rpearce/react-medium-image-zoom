import{R as e}from"./iframe-CNnS3tRA.js";import{C as K}from"./styles-Be3J10bd.js";/* empty css             */import{d as P,i as h,a as r,f as Q,j,k as _,l as A,m as F,n as U}from"./index-CQ5SO9GX.js";import{U as l}from"./uncontrolled-DnGtLW6s.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DqgUH6_T.js";import"./index-CqlqVier.js";const{waitFor:R,within:q,userEvent:W,expect:u}=__STORYBOOK_MODULE_TEST__,me={title:"<img>",component:l};function X(a){const o=structuredClone(a);for(let t=o.length-1;t>0;t-=1){const n=Math.floor(Math.random()*(t+1));[o[t],o[n]]=[o[n],o[t]]}return o}const d=a=>{const o=e.useCallback((t,{event:n})=>{console.log("handleZoomChange info!",{value:t,event:n})},[]);return e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Zooming a regular image"),e.createElement("div",{className:"mw-600",style:{display:"flex",flexDirection:"column"}},e.createElement(l,{...a,onZoomChange:o,wrapElement:"span"},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"}))))},y=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Setting a zoomMargin of 45(px)"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"This example should always be offset from the window by at least 45px"),e.createElement(l,{...a,zoomMargin:45},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"})))),w=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"A portrait image with a small width specified"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"Small size specifications scale well, too — even on mobile."),e.createElement(l,{...a},e.createElement("img",{alt:U.alt,src:U.src,height:"112",decoding:"async",loading:"lazy"})))),f=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"An image with an SVG src"),e.createElement("div",{className:"mw-600"},e.createElement(l,{...a},e.createElement("img",{alt:F.alt,src:F.src,width:"150",decoding:"async",loading:"lazy"})))),v=()=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"An image with a ",e.createElement("code",null,"data:image/svg+xml")," ",e.createElement("code",null,"src")),e.createElement("div",{className:"data-uri-img mw-600"},e.createElement(l,null,e.createElement("img",{alt:"Gatsby G Logo",src:"data:image/svg+xml,%3Csvg width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M12 2a10 10 0 110 20 10 10 0 010-20zm0 2c-3.73 0-6.86 2.55-7.75 6L14 19.75c3.45-.89 6-4.02 6-7.75h-5.25v1.5h3.45a6.37 6.37 0 01-3.89 4.44L6.06 9.69C7 7.31 9.3 5.63 12 5.63c2.13 0 4 1.04 5.18 2.65l1.23-1.06A7.959 7.959 0 0012 4zm-8 8a8 8 0 008 8c.04 0 .09 0-8-8z' fill='%23639'/%3E%3C/svg%3E"})))),b=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"An image with a larger ",e.createElement("code",null,"zoomImg")),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"When zoomed, the original image will scale to as large as the window will allow, and then it will be replaced by an image that is downloaded in the background."),e.createElement(l,{...a,zoomImg:{alt:_.alt,src:_.src}},e.createElement("img",{alt:A.alt,src:A.src,width:"150"})))),$=({img:a,isZoomImgLoaded:o,modalState:t})=>{const[n,s]=e.useState(!1);e.useEffect(()=>{if(t!=="LOADING"||!o)return;const i=setTimeout(()=>{s(!0)},1e3);return()=>{clearTimeout(i),s(!1)}},[o,t]);const m=t==="LOADING"&&!n;return e.createElement(e.Fragment,null,a,m&&e.createElement("div",{className:"zoom-img-loader-wrapper"},e.createElement("div",{className:"zoom-img-loader"})))},z=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"ZoomImg with Loading State"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"This example shows how to provide loading feedback when using a high-resolution ",e.createElement("code",null,"zoomImg"),". The ",e.createElement("code",null,"ZoomContent")," ","component uses the ",e.createElement("code",null,"isZoomImgLoaded")," prop to display a loading spinner while the high-resolution image is being downloaded."),e.createElement("p",null,"Here the loading spinner is shown on every zoom, but in a real-world case, the browser caches the image, so you'll only see the loader at first load."),e.createElement(l,{...a,zoomImg:{alt:_.alt,src:_.src},ZoomContent:$},e.createElement("img",{alt:A.alt,src:A.src,width:"150"})),e.createElement("h2",null,"Code"),e.createElement("pre",null,e.createElement("code",null,`
...
>
  <img src='low-res-image.jpg' width="150" />
          ...
          `)))),S=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"An image with a small size"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"In order to prevent blurry images, An image won't scale up larger than its natural dimensions."),e.createElement(l,{...a},e.createElement("img",{alt:A.alt,src:A.src,width:"150"})))),C=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Custom Modal Styles"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"Use CSS to customize the zoom modal styles."),e.createElement("p",null,"Here, we slow down the transition time and use a different overlay color."),e.createElement("div",null,e.createElement(l,{...a,classDialog:"custom-zoom"},e.createElement("img",{alt:h.alt,src:h.src,width:"400"}))),e.createElement("p",null,"The CSS class, ",e.createElement("code",null,"custom-zoom"),", is sent to the component via the ",e.createElement("code",null,"classDialog")," string prop. Here are the styles used:"),e.createElement("pre",null,e.createElement("code",null,`
...
`)))),Z=a=>{const o=e.useRef(null),t=e.useRef(null),n=e.useCallback(()=>{t.current?.showModal()},[]);return e.useEffect(()=>{const s=m=>{const{target:i}=m;i instanceof Element&&o.current?.contains(i)!==!0&&t.current?.contains(i)!==!0&&t.current?.close()};return document.addEventListener("click",s),()=>{document.removeEventListener("click",s)}},[]),e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Zoom Image From Inside Dialog"),e.createElement("div",{className:"mw-600"},e.createElement("button",{onClick:n,ref:o,type:"button"},"Open Modal"),e.createElement("dialog",{"aria-modal":"true",ref:t},e.createElement("form",{method:"dialog"},e.createElement("button",{type:"submit"},"Close")),e.createElement("h1",null,"Zooming should work!"),e.createElement("div",null,e.createElement(l,{...a},e.createElement("img",{alt:h.alt,src:h.src,width:"400"}))))))},T=a=>{const[o,t]=e.useState(!1),n=e.useCallback(s=>{t(s)},[]);return e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Modal With Figure And Caption"),e.createElement("p",null,"If you want more control over the zoom modal's content, you can pass a ",e.createElement("code",null,"ZoomContent")," component."),e.createElement("h2",null,"Uncontrolled"),e.createElement("div",{className:"mw-600"},e.createElement(l,{...a,ZoomContent:H},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"}))),e.createElement("h2",null,"Controlled"),e.createElement("p",null,"Regression for"," ",e.createElement("a",{href:"https://github.com/rpearce/react-medium-image-zoom/issues/448"},"issue #448"),": when the parent owns ",e.createElement("code",null,"isZoomed")," and passes"," ",e.createElement("code",null,"ZoomContent")," as an inline arrow function, its identity changes on every parent render, causing the modal subtree to remount. Zoom and unzoom should both animate smoothly."),e.createElement("div",{className:"mw-600"},e.createElement(K,{isZoomed:o,onZoomChange:n,ZoomContent:s=>e.createElement(H,{...s})},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"}))))},H=({buttonUnzoom:a,modalState:o,img:t})=>{const n=o==="LOADED",s=e.isValidElement(t)?t:null,m=s?.props.width,i=s?.props.height,p=e.useMemo(()=>{const E=m!==void 0&&i!==void 0,c=E?m/i>window.innerWidth/window.innerHeight:!1;return ee({"zoom-caption":!0,"zoom-caption--loaded":n,"zoom-caption--bottom":E&&c,"zoom-caption--left":E&&!c})},[m,i,n]);return e.createElement(e.Fragment,null,a,e.createElement("figure",null,t,e.createElement("figcaption",{className:p},"That Wanaka Tree, also known as the Wanaka Willow, is a willow tree located at the southern end of Lake Wānaka in the Otago region of New Zealand.",e.createElement("cite",{className:"zoom-caption-cite"},"Wikipedia,"," ",e.createElement("a",{className:"zoom-caption-link",href:"https://en.wikipedia.org/wiki/That_Wanaka_Tree"},"That Wanaka Tree")))))},J=a=>{const{alt:o,height:t,src:n,timer:s,width:m}=a,i=s===0?{opacity:0,visibility:"hidden",position:"absolute"}:{opacity:1};return e.useEffect(()=>{const p=new Image;p.src=n,p.decode()},[n]),e.createElement("div",null,e.createElement("img",{alt:"","aria-hidden":"true",decoding:"async",height:t,src:"data:image/jpeg;base64,",style:i,width:m}),s===0&&e.createElement("img",{alt:o,decoding:"async",loading:"lazy",src:n,width:m}))},I=a=>{const{timer:o}=O(5e3);return e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"A sub-component which delays rendering"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"This examples simulates an issue caused by the gatsby-plugin-image (and potentially others) where the actual image element isn't found on the first render."),e.createElement("div",null,"Image loads in: ",e.createElement("span",{role:"timer"},o/1e3)),e.createElement(l,{...a},e.createElement(J,{timer:o,alt:j.alt,src:j.src,height:"200",width:"400"}))))},N=a=>{const{timer:o}=O(5e3),t=o===0?void 0:"display-none";return e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"A delayed ",e.createElement("code",null,"display: none;")," image"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"This examples simulates an image being hidden with CSS and then shown after the countdown."),e.createElement("div",null,"Image loads in: ",e.createElement("span",{role:"timer"},o/1e3)),e.createElement(l,{...a},e.createElement("img",{alt:Q.alt,src:Q.src,className:t,height:"320",decoding:"async",loading:"lazy"}))))},k=a=>(e.useEffect(()=>(document.body.classList.add("change-icons"),()=>{document.body.classList.remove("change-icons")}),[]),e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"An image with custom zoom & unzoom icons"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"Press TAB to activate the zoom button"),e.createElement("div",null,e.createElement(l,{...a,IconZoom:()=>e.createElement(e.Fragment,null,"+"),IconUnzoom:()=>e.createElement(e.Fragment,null,"-")},e.createElement("img",{alt:P.alt,src:P.src,width:"400"})))))),x=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Inline Image"),e.createElement("p",{className:"inline"},"This example is of an image that is inline with text.",e.createElement(l,{...a,wrapElement:"span"},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"})))),D=a=>{const[o,t]=e.useState(r);return e.useEffect(()=>{const n=setInterval(()=>{t(X([r,j,F,Q,_,U,h,P])[0])},3e3);return()=>{clearInterval(n)}},[]),e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Cycle through images"),e.createElement("p",null,"This helps to test the ghost element that positions the button. Press Tab to focus the button, then sit and watch it reposition with each new image!"),e.createElement("p",null,e.createElement(l,{...a,wrapElement:"span"},e.createElement("img",{alt:o.alt,src:o.src,height:"320",decoding:"async",loading:"lazy"}))))},L=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Swipe to Unzoom Disabled"),e.createElement("p",null,"This example demonstrates preventing swipe gestures from unzooming when an image is zoomed. This is best tested on a touchscreen device!"),e.createElement("div",null,e.createElement(l,{...a,canSwipeToUnzoom:!1},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"})))),B=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Swipe to Unzoom Threshold"),e.createElement("p",null,"This example demonstrates increasing the threshold required for a swipe gesture on a touchscreen device to unzoom when an image is zoomed. This is best tested on a touchscreen device!"),e.createElement("p",null,"The default is ",e.createElement("code",null,"10")," (px), but this example is set to"," ",e.createElement("code",null,"200")," (px); that's how far you'll have to move your finger across the screen."),e.createElement("div",null,e.createElement(l,{...a,swipeToUnzoomThreshold:200},e.createElement("img",{alt:r.alt,src:r.src,height:"320",decoding:"async",loading:"lazy"})))),M=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Selecting cards and zooming without triggering selection state"),e.createElement("div",{className:"mw-600",style:{display:"flex",flexDirection:"column"}},e.createElement("ul",{className:"cards"},e.createElement(Y,{alt:r.alt,src:r.src,zoomProps:a}),e.createElement(Y,{alt:h.alt,src:h.src,zoomProps:a}))));function Y({alt:a,src:o,zoomProps:t}){const[n,s]=e.useState(!1),m=e.useCallback(()=>{s(c=>!c)},[]),i=e.useCallback(c=>{c.stopPropagation()},[]),p=e.useCallback(c=>{s(c.currentTarget.checked)},[]),E=e.useCallback((c,{event:G})=>{G.stopPropagation(),console.log("handleZoomChange (after event.stopPropagation())",{value:c,event:G})},[]);return e.createElement("li",{className:"card",onClick:m},e.createElement("label",null,e.createElement("input",{"aria-label":"Select item",checked:n,onChange:p,onClick:i,type:"checkbox"})),e.createElement(l,{...t,onZoomChange:E,wrapElement:"span"},e.createElement("img",{alt:a,src:o,height:"320",width:"320",decoding:"async",loading:"lazy"})))}const g=d.bind({});g.args={...d.args};g.storyName="(Automated Test)";g.play=async({canvasElement:a})=>{const o=q(a);await R(async()=>{await u(o.getByLabelText(`Expand image: ${r.alt}`)).toBeVisible()}),await V(1e3),await W.tab(),await W.keyboard("{Enter}",{delay:1e3}),await R(async()=>{const t=document.querySelector("dialog");if(t==null)throw new Error("rmiz automated test failure: cannot find <dialog>");await u(t).toHaveAttribute("open"),await u(t.querySelector(`img[alt="${r.alt}"]`)).toBeVisible(),await u(t.querySelector('[aria-label="Minimize image"')).toHaveFocus()}),await V(1e3),await W.keyboard("{Escape}",{delay:1e3}),await R(async()=>{await u(document.querySelector("dialog")).not.toHaveAttribute("open"),await u(o.getByLabelText(`Expand image: ${r.alt}`)).toHaveFocus()})};const ee=a=>{const o=[];for(const t in a)a[t]===!0&&o.push(t);return o.join(" ")},V=async a=>{await new Promise(o=>{setTimeout(o,a)})},O=a=>{const[o,t]=e.useState(a);return e.useEffect(()=>{const n=setInterval(()=>{o===0?clearInterval(n):t(o-1e3)},1e3);return()=>{clearInterval(n)}},[o]),{timer:o}};d.__docgenInfo={description:"",methods:[],displayName:"Regular"};y.__docgenInfo={description:"",methods:[],displayName:"ZoomMargin"};w.__docgenInfo={description:"",methods:[],displayName:"SmallPortrait"};f.__docgenInfo={description:"",methods:[],displayName:"SVGSource"};v.__docgenInfo={description:"",methods:[],displayName:"DataSVGSource"};b.__docgenInfo={description:"",methods:[],displayName:"ProvideZoomImg"};z.__docgenInfo={description:"",methods:[],displayName:"ZoomImgLoader"};S.__docgenInfo={description:"",methods:[],displayName:"SmallSrcSize"};C.__docgenInfo={description:"",methods:[],displayName:"CustomModalStyles"};Z.__docgenInfo={description:"",methods:[],displayName:"ZoomImageFromInsideDialog"};T.__docgenInfo={description:"",methods:[],displayName:"ModalFigureCaption"};I.__docgenInfo={description:"",methods:[],displayName:"DelayedImageRender"};N.__docgenInfo={description:"",methods:[],displayName:"DelayedDisplayNone"};k.__docgenInfo={description:"",methods:[],displayName:"CustomButtonIcons"};x.__docgenInfo={description:"",methods:[],displayName:"InlineImage"};D.__docgenInfo={description:"",methods:[],displayName:"CycleImages"};L.__docgenInfo={description:"",methods:[],displayName:"SwipeToUnzoomDisabled"};B.__docgenInfo={description:"",methods:[],displayName:"SwipeToUnzoomThreshold"};M.__docgenInfo={description:"",methods:[],displayName:"SelectCards"};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`props => {
...
}`,...d.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`props => <main aria-label="Story">
  ...
  </main>`,...b.parameters?.docs?.source}}};z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`props => <main aria-label="Story">
...
>
  ...
  </main>`,...z.parameters?.docs?.source}}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`props => <main aria-label="Story">
  ...
  </main>`,...S.parameters?.docs?.source}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`props => <main aria-label="Story">
...
\`}
  ...
  </main>`,...C.parameters?.docs?.source}}};Z.parameters={...Z.parameters,docs:{...Z.parameters?.docs,source:{originalSource:`props => {
...
}`,...Z.parameters?.docs?.source}}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`props => {
...
}`,...T.parameters?.docs?.source}}};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`props => {
  const {
    timer
  } = useTimer(5000);
  return <main aria-label="Story">
  ...
  </main>`,...M.parameters?.docs?.source}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`props => {
  const handleZoomChange = React.useCallback<NonNullable<React.ComponentProps<typeof Zoom>['onZoomChange']>>((value, {
    event
  }) => {
    console.log('handleZoomChange info!', {
...
}`,...g.parameters?.docs?.source}}};const ce=["Regular","ZoomMargin","SmallPortrait","SVGSource","DataSVGSource","ProvideZoomImg","ZoomImgLoader","SmallSrcSize","CustomModalStyles","ZoomImageFromInsideDialog","ModalFigureCaption","DelayedImageRender","DelayedDisplayNone","CustomButtonIcons","InlineImage","CycleImages","SwipeToUnzoomDisabled","SwipeToUnzoomThreshold","SelectCards","AutomatedTest"];export{g as AutomatedTest,k as CustomButtonIcons,C as CustomModalStyles,D as CycleImages,v as DataSVGSource,N as DelayedDisplayNone,I as DelayedImageRender,x as InlineImage,T as ModalFigureCaption,b as ProvideZoomImg,d as Regular,f as SVGSource,M as SelectCards,w as SmallPortrait,S as SmallSrcSize,L as SwipeToUnzoomDisabled,B as SwipeToUnzoomThreshold,Z as ZoomImageFromInsideDialog,z as ZoomImgLoader,y as ZoomMargin,ce as __namedExportsOrder,me as default};
