...
`)))),T=a=>{const o=e.useRef(null),t=e.useRef(null),n=e.useCallback(()=>{t.current?.showModal()},[]);return e.useEffect(()=>{const s=c=>{const{target:i}=c;i instanceof Element&&o.current?.contains(i)!==!0&&t.current?.contains(i)!==!0&&t.current?.close()};return document.addEventListener("click",s),()=>{document.removeEventListener("click",s)}},[]),e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Zoom Image From Inside Dialog"),e.createElement("div",{className:"mw-600"},e.createElement("button",{onClick:n,ref:o,type:"button"},"Open Modal"),e.createElement("dialog",{"aria-modal":"true",ref:t},e.createElement("form",{method:"dialog"},e.createElement("button",{type:"submit"},"Close")),e.createElement("h1",null,"Zooming should work!"),e.createElement("div",null,e.createElement(r,{...a},e.createElement("img",{alt:p.alt,src:p.src,width:"400"}))))))},I=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Modal With Figure And Caption"),e.createElement("p",null,"If you want more control over the zoom modal's content, you can pass a ",e.createElement("code",null,"ZoomContent")," component"),e.createElement("div",{className:"mw-600"},e.createElement(r,{...a,ZoomContent:X},e.createElement("img",{alt:l.alt,src:l.src,height:"320",decoding:"async",loading:"lazy"})))),X=({buttonUnzoom:a,modalState:o,img:t})=>{const[n,s]=e.useState(!1),c=e.isValidElement(t)?t:null,i=c?.props.width,d=c?.props.height,R=e.useMemo(()=>{const m=i!==void 0&&d!==void 0,E=m?i/d>window.innerWidth/window.innerHeight:!1;return J({"zoom-caption":!0,"zoom-caption--loaded":n,"zoom-caption--bottom":m&&E,"zoom-caption--left":m&&!E})},[i,d,n]);return e.useLayoutEffect(()=>{o==="LOADED"?s(!0):o==="UNLOADING"&&s(!1)},[o]),e.createElement(e.Fragment,null,a,e.createElement("figure",null,t,e.createElement("figcaption",{className:R},"That Wanaka Tree, also known as the Wanaka Willow, is a willow tree located at the southern end of Lake Wānaka in the Otago region of New Zealand.",e.createElement("cite",{className:"zoom-caption-cite"},"Wikipedia,"," ",e.createElement("a",{className:"zoom-caption-link",href:"https://en.wikipedia.org/wiki/That_Wanaka_Tree"},"That Wanaka Tree")))))},$=a=>{const{alt:o,height:t,src:n,timer:s,width:c}=a,i=s===0?{opacity:0,visibility:"hidden",position:"absolute"}:{opacity:1};return e.useEffect(()=>{const d=new Image;d.src=n,d.decode()},[n]),e.createElement("div",null,e.createElement("img",{alt:"","aria-hidden":"true",decoding:"async",height:t,src:"data:image/jpeg;base64,",style:i,width:c}),s===0&&e.createElement("img",{alt:o,decoding:"async",loading:"lazy",src:n,width:c}))},Z=a=>{const{timer:o}=V(5e3);return e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"A sub-component which delays rendering"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"This examples simulates an issue caused by the gatsby-plugin-image (and potentially others) where the actual image element isn't found on the first render."),e.createElement("div",null,"Image loads in: ",e.createElement("span",{role:"timer"},o/1e3)),e.createElement(r,{...a},e.createElement($,{timer:o,alt:F.alt,src:F.src,height:"200",width:"400"}))))},N=a=>{const{timer:o}=V(5e3),t=o===0?void 0:"display-none";return e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"A delayed ",e.createElement("code",null,"display: none;")," image"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"This examples simulates an image being hidden with CSS and then shown after the countdown."),e.createElement("div",null,"Image loads in: ",e.createElement("span",{role:"timer"},o/1e3)),e.createElement(r,{...a},e.createElement("img",{alt:j.alt,src:j.src,className:t,height:"320",decoding:"async",loading:"lazy"}))))},k=a=>(e.useEffect(()=>(document.body.classList.add("change-icons"),()=>{document.body.classList.remove("change-icons")}),[]),e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"An image with custom zoom & unzoom icons"),e.createElement("div",{className:"mw-600"},e.createElement("p",null,"Press TAB to activate the zoom button"),e.createElement("div",null,e.createElement(r,{...a,IconZoom:()=>e.createElement(e.Fragment,null,"+"),IconUnzoom:()=>e.createElement(e.Fragment,null,"-")},e.createElement("img",{alt:Q.alt,src:Q.src,width:"400"})))))),x=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Inline Image"),e.createElement("p",{className:"inline"},"This example is of an image that is inline with text.",e.createElement(r,{...a,wrapElement:"span"},e.createElement("img",{alt:l.alt,src:l.src,height:"320",decoding:"async",loading:"lazy"})))),D=a=>{const[o,t]=e.useState(l);return e.useEffect(()=>{const n=setInterval(()=>{t(K([l,F,G,j,_,U,p,Q])[0])},3e3);return()=>{clearInterval(n)}},[]),e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Cycle through images"),e.createElement("p",null,"This helps to test the ghost element that positions the button. Press Tab to focus the button, then sit and watch it reposition with each new image!"),e.createElement("p",null,e.createElement(r,{...a,wrapElement:"span"},e.createElement("img",{alt:o.alt,src:o.src,height:"320",decoding:"async",loading:"lazy"}))))},L=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Swipe to Unzoom Disabled"),e.createElement("p",null,"This example demonstrates preventing swipe gestures from unzooming when an image is zoomed. This is best tested on a touchscreen device!"),e.createElement("div",null,e.createElement(r,{...a,canSwipeToUnzoom:!1},e.createElement("img",{alt:l.alt,src:l.src,height:"320",decoding:"async",loading:"lazy"})))),B=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Swipe to Unzoom Threshold"),e.createElement("p",null,"This example demonstrates increasing the threshold required for a swipe gesture on a touchscreen device to unzoom when an image is zoomed. This is best tested on a touchscreen device!"),e.createElement("p",null,"The default is ",e.createElement("code",null,"10")," (px), but this example is set to"," ",e.createElement("code",null,"200")," (px); that's how far you'll have to move your finger across the screen."),e.createElement("div",null,e.createElement(r,{...a,swipeToUnzoomThreshold:200},e.createElement("img",{alt:l.alt,src:l.src,height:"320",decoding:"async",loading:"lazy"})))),M=a=>e.createElement("main",{"aria-label":"Story"},e.createElement("h1",null,"Selecting cards and zooming without triggering selection state"),e.createElement("div",{className:"mw-600",style:{display:"flex",flexDirection:"column"}},e.createElement("ul",{className:"cards"},e.createElement(H,{alt:l.alt,src:l.src,zoomProps:a}),e.createElement(H,{alt:p.alt,src:p.src,zoomProps:a}))));function H({alt:a,src:o,zoomProps:t}){const[n,s]=e.useState(!1),c=e.useCallback(()=>{s(m=>!m)},[]),i=e.useCallback(m=>{m.stopPropagation()},[]),d=e.useCallback(m=>{s(m.currentTarget.checked)},[]),R=e.useCallback((m,{event:E})=>{E.stopPropagation(),console.log("handleZoomChange (after event.stopPropagation())",{value:m,event:E})},[]);return e.createElement("li",{className:"card",onClick:c},e.createElement("label",null,e.createElement("input",{"aria-label":"Select item",checked:n,onChange:d,onClick:i,type:"checkbox"})),e.createElement(r,{...t,onZoomChange:R,wrapElement:"span"},e.createElement("img",{alt:a,src:o,height:"320",width:"320",decoding:"async",loading:"lazy"})))}const h=g.bind({});h.args={...g.args};h.storyName="(Automated Test)";h.play=async({canvasElement:a})=>{const o=O(a);await W(async()=>{await u(o.getByLabelText(`Expand image: ${l.alt}`)).toBeVisible()}),await Y(1e3),await P.tab(),await P.keyboard("{Enter}",{delay:1e3}),await W(async()=>{const t=document.querySelector("dialog");if(t==null)throw new Error("rmiz automated test failure: cannot find <dialog>");await u(t).toHaveAttribute("open"),await u(t.querySelector(`img[alt="${l.alt}"]`)).toBeVisible(),await u(t.querySelector('[aria-label="Minimize image"')).toHaveFocus()}),await Y(1e3),await P.keyboard("{Escape}",{delay:1e3}),await W(async()=>{await u(document.querySelector("dialog")).not.toHaveAttribute("open"),await u(o.getByLabelText(`Expand image: ${l.alt}`)).toHaveFocus()})};const J=a=>{const o=[];for(const t in a)a[t]===!0&&o.push(t);return o.join(" ")},Y=async a=>{await new Promise(o=>{setTimeout(o,a)})},V=a=>{const[o,t]=e.useState(a);return e.useEffect(()=>{const n=setInterval(()=>{o===0?clearInterval(n):t(o-1e3)},1e3);return()=>{clearInterval(n)}},[o]),{timer:o}};g.__docgenInfo={description:"",methods:[],displayName:"Regular"};w.__docgenInfo={description:"",methods:[],displayName:"ZoomMargin"};y.__docgenInfo={description:"",methods:[],displayName:"SmallPortrait"};f.__docgenInfo={description:"",methods:[],displayName:"SVGSource"};v.__docgenInfo={description:"",methods:[],displayName:"DataSVGSource"};b.__docgenInfo={description:"",methods:[],displayName:"ProvideZoomImg"};S.__docgenInfo={description:"",methods:[],displayName:"ZoomImgLoader"};z.__docgenInfo={description:"",methods:[],displayName:"SmallSrcSize"};C.__docgenInfo={description:"",methods:[],displayName:"CustomModalStyles"};T.__docgenInfo={description:"",methods:[],displayName:"ZoomImageFromInsideDialog"};I.__docgenInfo={description:"",methods:[],displayName:"ModalFigureCaption"};Z.__docgenInfo={description:"",methods:[],displayName:"DelayedImageRender"};N.__docgenInfo={description:"",methods:[],displayName:"DelayedDisplayNone"};k.__docgenInfo={description:"",methods:[],displayName:"CustomButtonIcons"};x.__docgenInfo={description:"",methods:[],displayName:"InlineImage"};D.__docgenInfo={description:"",methods:[],displayName:"CycleImages"};L.__docgenInfo={description:"",methods:[],displayName:"SwipeToUnzoomDisabled"};B.__docgenInfo={description:"",methods:[],displayName:"SwipeToUnzoomThreshold"};M.__docgenInfo={description:"",methods:[],displayName:"SelectCards"};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`props => {
  ...
  </main>`,...w.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`props => <main aria-label="Story">
  ...
  </main>`,...y.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`props => <main aria-label="Story">
...
\`}
  ...
  </main>`,...C.parameters?.docs?.source}}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`props => {
