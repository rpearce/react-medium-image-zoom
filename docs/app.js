...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_.Controlled, {
...
},{"./src":26}],3:[function(require,module,exports){
'use strict'
...
var _simpleUniqueid = _interopRequireDefault(require("@rpearce/simple-uniqueid"));
...
/*#__PURE__*/
function (_PureComponent) {
  _inherits(Controlled, _PureComponent);
  ...
  function Controlled() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Controlled)).call.apply(_getPrototypeOf2, [this].concat(params)));
    ...
    _this.id = (0, _simpleUniqueid.default)('rmiz-');
    return _this;
  }
  ...
  _createClass(Controlled, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          isZoomed = _this$props.isZoomed,
          label = _this$props.label;
      return _react.default.createElement(_react.StrictMode, null, _react.default.createElement(_reactButtonA11y.default, {
...
},{"@rpearce/simple-uniqueid":3,"react":18,"react-button-a11y":9}],26:[function(require,module,exports){
"use strict";
